...
# BDNE-Chart_Version-iPy2 (Graphical User Interface Version)
...
##                        print "Enter any other number to plot the normal chart that highlights all dominant probability values (P1n, P2n, P3n)."
        ...
        label2.grid(column=0,row=7,columnspan=5,sticky='EW') #label widget
        ...
        label4.grid(column=0,row=9,columnspan=5,sticky='EW') #label widget
        label5 = Tkinter.Label(self,anchor='w',text=u"        if [Delta N = 0 & Delta Z = 0] or [Delta N = 4 & Delta Z = 4]")
        label5.grid(column=0,row=10,columnspan=5,sticky='EW') #label widget
        ...
        PLOT_Button = Tkinter.Button(self,text=u"PLOT",command=PLOT)
        PLOT_Button.grid(column=2,row=28)

        #create first widget, an Entry widget
        #When a cell grows larger than the widget it contains,
...
if __name__ == "__main__":
    ...
    app.mainloop() #program loops indefinitely, waiting for events
